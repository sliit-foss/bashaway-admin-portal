                ...
                <form>
                    <div className="flex flex-col gap-y-4 mb-4">
                        <div className='w-full flex justify-center items-center gap-x-4'>
                            <Input placeholder="Question Name" name="name" value={formData.name} wrapperclasses="w-full md:w-1/2" className="h-12 sm:h-14 light" theme="light" onChange={onChange} />
                            <Input placeholder="Upload Sample Code" name="codebase_url" value={formData.codebase_url} wrapperclasses="w-full md:w-1/2" className="h-12 sm:h-14 cursor-pointer light" theme="light" disabled={!formData.name} onClick={() => {
                        ...
                        <div className='w-full flex flex-col md:flex-row justify-center items-center gap-y-4 md:gap-y-0 gap-x-4'>
                            ...
                            <Dropdown filterkey="enabled" placeholder="Status" options={enabledFilters} wrapperclasses="w-full md:w-4/12" className="w-full h-12 sm:h-14 light" theme="light" value={formData.enabled} onChange={onChange} />
                            {(!question || question.creator === currentUser._id) && <Dropdown filterkey="creator_lock" placeholder="Creator Lock" options={enabledFilters} wrapperclasses="w-full md:w-4/12" className="w-full h-12 sm:h-14 light" theme="light" value={formData.creator_lock} onChange={onChange} />}
                            <Input placeholder="Maximum Score" name="max_score" value={formData.max_score} type="number" wrapperclasses="w-full md:w-4/12" className="w-full h-12 sm:h-14 light" theme="light" onChange={onChange} />
                        </div>
                        <Input placeholder="Constraints (Comma Separated)" name="constraints" value={formData.constraints} className="h-12 sm:h-14 light" theme="light" onChange={onChange} />
