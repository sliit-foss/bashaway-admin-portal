...
export const Actions = ({ submission, className, buttonClassName }) => (
  <div className={twMerge("w-full md:w-auto flex flex-row justify-center md:justify-end items-center gap-3 mt-1", className)}>
    <Button className={twMerge("w-full sm:w-auto self-center py", buttonClassName)} disabled={!submission} onClick={() => onGradeClick(submission)}>
      Grade
    </Button>
    <IconButton
      variant="secondary"
