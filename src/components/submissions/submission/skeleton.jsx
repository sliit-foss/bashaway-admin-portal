      ...
      {Array.from({ length: 3 }).map((_, i) => (
        ...
        >
          <div className="w-full flex flex-col items-center md:items-start gap-2 md:gap-1">
            <Skeleton
              className="w-[280px] md:w-[340px] h-[1.4rem] sm:h-[1.45rem] md:h-[1.45rem] lg:h-[1.55rem] mb-[0.2rem]"
              shade="dark"
              single
            />
            {!md && (
              <Skeleton
                className="w-[240px] md:w-[240px] h-[1.4rem] sm:h-[1.45rem] md:h-[1.45rem] lg:h-[1.55rem]"
                shade="dark"
                single
              />
            )}
